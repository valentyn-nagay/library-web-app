...
3. После успешного старта приложения будут доступны следующие URL:
    ...
    - Каталог книг:  
      `http://localhost:18080/books`
    - Выдача книг:  
      `http://localhost:18080/loans`
    - Страница входа:  
...
- Страница входа: `http://localhost:18080/login`
- Логин: `admin`
- Пароль: `admin`
...
1. Откройте страницу регистрации: `http://localhost:18080/register`.
